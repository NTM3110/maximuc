...
# Usage:
#   ./netcfg.sh <iface> dhcp
#   ./netcfg.sh <iface> static <ip> <netmask|prefix> <gateway> [dns1] [dns2]
#
# Examples:
#   ./netcfg.sh enp0s31f6 dhcp
#   ./netcfg.sh enp0s31f6 static 192.168.101.50 24 192.168.101.1
#   ./netcfg.sh enp0s31f6 static 192.168.101.50 255.255.255.0 192.168.101.1 8.8.8.8 1.1.1.1
...
Usage:
  $0 <iface> dhcp
  $0 <iface> static <ip> <netmask|prefix> <gateway> [dns1] [dns2]

Examples:
  $0 enp0s31f6 dhcp
  $0 enp0s31f6 static 192.168.101.50 24 192.168.101.1
  $0 enp0s31f6 static 192.168.101.50 255.255.255.0 192.168.101.1 8.8.8.8 1.1.1.1
EOF
  exit 1
}
...
plain_stop_dhcp() {
  ...
  if command -v dhcpcd >/devnull 2>&1; then
